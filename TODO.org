...
** TODO Printing style partially ignored by Safari on IPadOS (BM-2)
:PROPERTIES:
...
** TODO Frame around the header has now vanished in printing style (BM-3)

* [9/15] Release Readiness
...
** TODO Check license notes again
** TODO make a thumbnail and a screenshot
...
* [0/11] Post Release, Pre Production Improvements
